...
<body>
		...
		<span class='checkInputEmpty_newUserId'>
                ...
                <span class="passwordFormat">
                    <?php echo isset($validationErrors['passwordFormat'])||!empty($validationErrors['passwordFormat'])?
                ...
                <span class="checkInputEmpty_passwordConfirm">
                    <?php echo isset($validationErrors['checkInputEmpty_passwordConfirm'])||!empty($validationErrors['checkInputEmpty_passwordConfirm'])?
                        $validationErrors['checkInputEmpty_passwordConfirm'] : "";
                    ?>
                </span>
                <span class="confirmPassword">
                    <?php echo isset($validationErrors['confirmPassword'])||!empty($validationErrors['confirmPassword'])?
