...
INSERT INTO t_users (userId, followId, email, password, name, imageUrl, workYear, language, comment) VALUES ('nakano',1,'m15sc018.prog@gmail.com','$2y$10$/Z674hRtyMYcxJAFOndUyuzQuaLUgagu9qDti3i2i505pfqnh6yXW','nakano','https://techbooklabo.s3.ap-northeast-1.amazonaws.com/profileImages/img_1582685779377.jpeg',0,'php、java、','本レビューサイトの作成者のnakanoです。転職用のポートフォリオとして学習開始5か月目に作成しました。勉強のためフレームワークを使用せず素のPHPで開発し、AWS(EC2/RDS/S3/ALB/Route53)でデプロイしました。よろしくお願いしま す。');
INSERT INTO t_users (userId, followId, email, password, name, imageUrl, workYear, language, comment) VALUES ('nonameUser1',7,'','$2y$10$PR0zz.f6aNtV1kELarH.kO/V0Myw5s2SXQgqPAEL93O9KODUYyY3W','','',0,'','');
INSERT INTO t_users (userId, followId, email, password, name, imageUrl, workYear, language, comment) VALUES ('testUser1',2,'test1@test1.com','$2y$10$7MY7dJ.UOgYL1kNRGnh9/.iC49/53fmif3uK8rs6gItLcO4CEWstS','testUser1','',0,'Java','テストユーザー1のコメント');
INSERT INTO t_users (userId, followId, email, password, name, imageUrl, workYear, language, comment) VALUES ('testUser2',3,'','$2y$10$8uUS5RFWrxrZY0CoTnvko.Q6neB8YgdnFe4GNK4oyCuwPu.zn9QH2','','',0,'','');
INSERT INTO t_users (userId, followId, email, password, name, imageUrl, workYear, language, comment) VALUES ('testUser3',4,'','$2y$10$uiiMsMe6ZhVyeysogjgcveaFi7wd5prwvN0ODrcZ/4gbCnQxw2iLu','','',0,'','');
INSERT INTO t_users (userId, followId, email, password, name, imageUrl, workYear, language, comment) VALUES ('testUser4',6,'','$2y$10$WFF0KCK2WaI3oDi6Lz6iE.za5Hb/p6CwKsY.mepYGzDPP1YI3eujK','','',0,'','');
